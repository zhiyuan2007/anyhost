...
var fResult string = "network_after_split.txt" + fileSuffix
var fMiddle string = "middle_result_store.txt" + fileSuffix
var f_breakpoint_file string = "breakpoint.txt"

//var fIpInfo string = "ip_not_the_same_network.txt"
var fIpInfo string = "all/all_detected_ip.txt"

var taobaoURL string = "http://ip.taobao.com/service/getIpInfo.php?ip="
